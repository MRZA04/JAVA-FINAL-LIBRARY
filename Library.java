...
public class Library {
	...
	public void searchTitle(String bookName) {
	    boolean match = false;
	    for (Book book : books) {
	...
	public void searchAuthor(String author) {
		...
		for (Book book : books) {
			...
			System.out.println("No author found matching: "+ author);
		}
	}
	...
	public void searchPublisher(String publisher) {
		...
		for (Book book : books) {
			...
			System.out.println("No publisher found matching: "+ publisher);
		}
	}
	
	public void searchIssueDate(int year,int month,int day) {
		LocalDate issueDate = LocalDate.of(year, month, day);
		boolean match = false;
		for (Loan loan : loans) {
			if (loan.getIssueDate().equals(issueDate)) {
				loan.printLoan();
				match = true;
			}
		} if (!match) {
			System.out.println("No Loans set on: "+ issueDate);
		}
	}
	
	
	public void searchDueDate(int year,int month, int day) {
		...
		for (Loan loan : loans) {
			...
			System.out.println("No Loans set on: "+ dueDate);
		}
	}
	
	public void searchFiction() {
		boolean match = false;
		for (Book book : books) {
			if (book.getFiction()) {
				book.printBook();
		...
		if (!match) {
			System.out.println("No fiction books in system");	
		}
	}
	
	public void searchNonFiction() {
		boolean match = false;
		for (Book book : books) {
			if (!book.getFiction()) {
				book.printBook();
		...
		if (!match) {
			System.out.println("No non-fiction books in system");	
		}
	}
	...
	public void searchFName(String fName) {
		boolean match = false;
		for (Member member : members) {
			if (member.getFName().toLowerCase().equals(fName.toLowerCase())) {
				member.printMember();
				match = true;
			}
		} if (!match) {
			System.out.println("No members matching the name : "+ fName);
		}
	...
	public void searchLName(String lName) {
		boolean match = false;
		for (Member member : members) {
			if (member.getLName().toLowerCase().equals(lName.toLowerCase())) {
				member.printMember();
				match = true;
			}
		} if (!match) {
			System.out.println("No members matching the name : "+ lName);
		}
	...
	public void searchPhone(String phone) {
		boolean match = false;
		for (Member member : members) {
			if (member.getPhone().toLowerCase().equals(phone.toLowerCase())) {
				member.printMember();
				match = true;
			}
		} if (!match) {
			System.out.println("No members matching the name : "+ phone);
		}
		
	}
	
	public void searchJoined(int year, int month, int day) {
		LocalDate joined = LocalDate.of(year, month, day);
		boolean match = false;
		for (Member member : members) {
			if (member.getJoined().equals(joined)) {
				member.printMember();
				match = true;
			}
		} if (!match) {
			System.out.println("No members joined on: "+ joined);
		}
